...
namespace BuMatrixSecurityRoleAssigner.Core.Entities
{
	...
	public partial class Team : Microsoft.Xrm.Sdk.Entity, System.ComponentModel.INotifyPropertyChanging, System.ComponentModel.INotifyPropertyChanged
	{
		...
		public System.Collections.Generic.IEnumerable<BuMatrixSecurityRoleAssigner.Core.Entities.SystemUser> teammembership_association
		{
			get
			{
				return this.GetRelatedEntities<BuMatrixSecurityRoleAssigner.Core.Entities.SystemUser>("teammembership_association", null);
			}
			set
			{
				this.OnPropertyChanging("teammembership_association");
				this.SetRelatedEntities<BuMatrixSecurityRoleAssigner.Core.Entities.SystemUser>("teammembership_association", null, value);
		...
		public System.Collections.Generic.IEnumerable<BuMatrixSecurityRoleAssigner.Core.Entities.Role> teamroles_association
		{
			get
			{
				return this.GetRelatedEntities<BuMatrixSecurityRoleAssigner.Core.Entities.Role>("teamroles_association", null);
			}
			set
			{
				this.OnPropertyChanging("teamroles_association");
				this.SetRelatedEntities<BuMatrixSecurityRoleAssigner.Core.Entities.Role>("teamroles_association", null, value);
		...
		public BuMatrixSecurityRoleAssigner.Core.Entities.BusinessUnit business_unit_teams
		{
			get
			{
				return this.GetRelatedEntity<BuMatrixSecurityRoleAssigner.Core.Entities.BusinessUnit>("business_unit_teams", null);
			}
			set
			{
				this.OnPropertyChanging("business_unit_teams");
				this.SetRelatedEntity<BuMatrixSecurityRoleAssigner.Core.Entities.BusinessUnit>("business_unit_teams", null, value);
		...
		public BuMatrixSecurityRoleAssigner.Core.Entities.SystemUser lk_team_createdonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<BuMatrixSecurityRoleAssigner.Core.Entities.SystemUser>("lk_team_createdonbehalfby", null);
			}
		}
		...
		public BuMatrixSecurityRoleAssigner.Core.Entities.SystemUser lk_team_modifiedonbehalfby
		{
			get
			{
				return this.GetRelatedEntity<BuMatrixSecurityRoleAssigner.Core.Entities.SystemUser>("lk_team_modifiedonbehalfby", null);
			}
		}
		...
		public BuMatrixSecurityRoleAssigner.Core.Entities.SystemUser lk_teambase_administratorid
		{
			get
			{
				return this.GetRelatedEntity<BuMatrixSecurityRoleAssigner.Core.Entities.SystemUser>("lk_teambase_administratorid", null);
			}
			set
			{
				this.OnPropertyChanging("lk_teambase_administratorid");
				this.SetRelatedEntity<BuMatrixSecurityRoleAssigner.Core.Entities.SystemUser>("lk_teambase_administratorid", null, value);
		...
		public BuMatrixSecurityRoleAssigner.Core.Entities.SystemUser lk_teambase_createdby
		{
			get
			{
				return this.GetRelatedEntity<BuMatrixSecurityRoleAssigner.Core.Entities.SystemUser>("lk_teambase_createdby", null);
			}
		}
		...
		public BuMatrixSecurityRoleAssigner.Core.Entities.SystemUser lk_teambase_modifiedby
		{
			get
			{
				return this.GetRelatedEntity<BuMatrixSecurityRoleAssigner.Core.Entities.SystemUser>("lk_teambase_modifiedby", null);
			}
		}
	}
}
